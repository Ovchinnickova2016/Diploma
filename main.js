...
//    ImageCreate(100,100,100,100,"cloudSvg",svg,"images/cloud.svg");
  ...
  //  var table = document.createElementNS('table');
   ...
   // переменная cheсk создаёт кнопку для функции CheckAnswer()
    ...
    LineCreate(400, 370, 400, 510, 4, 'black', 10, svg);//между 2 компом и коммутатором
    LineCreate(440, 370, 600, 510, 4, 'black', 11, svg);//между 3 компом и коммутатором
    ImageCreate(450, 100, 60, 60, '#00000', 12, svg, "images/file.svg");
...
function ImageCreate(x,y,width,height,color,id,mysvg,href)
{
